  ...
  render() {
    ...
    return(
      <Grid className="education-details">
        ...
        <Cell col= {8}>
          <h4 style= {{marginTop:'0px', fontFamily: "Patrick Hand Regular", fontSize: "30px"}}>{this.props.schoolName}</h4>
          <h5 style= {{marginTop:'12px', fontFamily: "Patrick Hand Regular", fontSize: "24px"}}><u>{this.props.schoolDegree}</u> {starsArray}</h5>
          {degreeArray}
          <h5 style= {{marginTop:'12px', fontFamily: "Patrick Hand Regular", fontSize: "24px"}}><u>{this.props.schoolAwards}</u> {starsArray}</h5>
          {awardsArray}
          <h5 style= {{marginTop:'12px', fontFamily: "Patrick Hand Regular", fontSize: "24px"}}><u>{this.props.schoolLeadership}</u></h5>
          {leadershipArray}
          <h5 style= {{marginTop:'12px', fontFamily: "Patrick Hand Regular", fontSize: "24px"}}><u>{this.props.schoolCommService}</u></h5>
          {commServiceArray}
