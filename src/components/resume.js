          ...
          <div className="sticky-top">
            ...
            <div className="resume-summary">
              ...
              <div className="resume-shortcuts">
                ...
                <HashLink className="btn btn-outline-secondary resume-button" smooth to="/resume#resume-education">Education</HashLink>
                <HashLink className="btn btn-outline-secondary resume-button" smooth to="/resume#resume-skills">Skills</HashLink>
              </div>
                <br/>
